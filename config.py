...
class Config(object):
    ...
    # Public deployment: keep registration closed unless you explicitly enable it.
    ...
    # Paid LLM usage caps (receipt scan = one LLM call).
    ...
    # Burst protection on /scan POST (per client IP).
